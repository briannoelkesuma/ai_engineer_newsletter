...
flowchart TD
    ...
    subgraph 3. Distribution & Presentation
        F -->|6. Send Video Breakdown| G[Telegram Topic: #Video Updates]
        D -->|7. Rebuild public/index.html & Commit| H[GitHub Pages Archive]
        USER[User on Telegram] -->|/digest Command| I[catchup_digest.py]
...
|---|---|---|
| 📹 **Video Updates** | `TELEGRAM_SUMMARY_THREAD_ID` | Receives individual video breakdowns with key ideas, architecture takeaways, and links. |
...
├── .github/workflows/
│   └── process_videos.yml     # GitHub Actions runner workflow
